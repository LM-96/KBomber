...
class BufferedReaderFlowWrapper(
    ...
    private val internalFlow = MutableSharedFlow<String>(reply, extraBufferCapacity, onBufferOverflow)

    /**
     * The new [SharedFlow] that can be used instead of the old [BufferedReader]
     */
    val sharedFlow : SharedFlow<String> = internalFlow.asSharedFlow()
